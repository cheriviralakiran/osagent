...
user_prompt = "Which process is listening port 56036 on my machine? The operating system is macos. First get the command from the prompt and then use execute_command tool for executing the command"
